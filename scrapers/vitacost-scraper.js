...
class VitacostScraper {
  constructor() {
    this.baseUrl = 'https://www.vitacost.com';
    this.searchUrl = 'https://www.vitacost.com/search';
    this.browser = null;
  }
  ...
  async searchProducts(query, category = 'wellness', limit = 20) {
    ...
    try {
      ...
      await page.setExtraHTTPHeaders({
        ...
        'Pragma': 'no-cache',
        'Referer': 'https://www.vitacost.com/'
      });
      ...
      console.log(`Searching Vitacost for: ${query}`);
          ...
          try {
            ...
            if (nameElement) {
              const product = {
                ...
                rating: null, // Vitacost might not show ratings on search page
      ...
      console.log(`Found ${products.length} products on Vitacost`);
      return products.slice(0, limit);
      
    } catch (error) {
      console.error('Vitacost scraper error:', error.message);
      return [];
    } finally {
...
module.exports = VitacostScraper; 